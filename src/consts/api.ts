...
export const API_PROJECTS = (orgId: string) =>
  `${API_BASE_URL}/api/v1/orgs/organizations/${orgId}/projects/`;
...
export const APP_DASHBOARD_USER_MEMORY = (userId: string, memoryId: string) =>
  `${APP_BASE_URL}/dashboard/user/${userId}?memoryId=${memoryId}`;
